...
import { USUARIOS } from '../../constantes/constantes';

const Unidad02Leccion02: React.FC = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="mb-3">
                <input type="text" value={valorBusqueda} onChange={manejoCambioValor} placeholder="Buscar..." />
            </div>
            <ul>
...
export default Unidad02Leccion02;
